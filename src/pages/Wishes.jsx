...
export default function Wishes() {
  ...
  const [isWillAttend, setIsWillAttend] = useState(false);
  const [message, setMessage] = useState("");

  const options = [
    { value: "ATTENDING", label: "Absolutely, I will attend the wedding!" },
    {
      value: "NOT_ATTENDING",
      label: "No, I am not ablo to attend the wedding",
    },
    { value: "MAYBE", label: "Probably, I am going to confirm it later" },
  ];
  ...
  const [wishes, setWishes] = useState([
    {
      ...
      timestamp: "2025-10-24T23:20:00Z",
      attending: "attending",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      timestamp: "2025-11-16T23:08:09Z",
      attending: "maybe",
    },
  ]);
  ...
  const handleSubmitWish = async () => {
    ...
    const newWishObj = {
      ...
      message: newWish,
      attend: "attending",
      //isWillAttend ? "attending" : "not attending",
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center space-x-2 text-gray-500 text-sm mb-1">
                      ...
                      <span>Are you going to attend the wedding?</span>
                    </div>
